  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 md:w-1/2 flex justify-center items-center bg-[#0b1220] p-4 md:p-12 min-h-screen md:min-h-0">
        <div className="w-full max-w-md bg-white dark:bg-[#111827] rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 p-6 md:p-10 space-y-8">
          {/* Mobile Logo */}
          ...
          <div className="text-center">
            ...
            <p className="text-gray-500 dark:text-[#dcd8d8] text-sm opacity-60">
