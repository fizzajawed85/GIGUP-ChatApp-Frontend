...
const CreateGroupModal = ({ onClose, onGroupCreated }) => {
    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 backdrop-blur-md animate-in fade-in duration-300">
            <div className="w-full sm:max-w-md bg-white dark:bg-[#1f2c33] rounded-t-3xl sm:rounded-3xl shadow-2xl overflow-hidden border dark:border-zinc-700/50 animate-in slide-in-from-bottom sm:zoom-in-95 duration-300 max-h-[90vh] flex flex-col">
